...
const DATETIME_PROMPT = 'datetimeEndPrompt';
const WATERFALL_DIALOG = 'waterfallDialog';

class DateResolverEndDialog extends CancelAndHelpDialog {
    constructor(id) {
        super(id || 'dateResolverEndDialog');
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = "Couldn't get the return date! On what date would you like to return?";
...
module.exports.DateResolverEndDialog = DateResolverEndDialog;
