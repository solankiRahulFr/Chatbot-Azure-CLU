...
const DATETIME_PROMPT = 'datetimeStartPrompt';
const WATERFALL_DIALOG = 'waterfallDialog';

class DateResolverStartDialog extends CancelAndHelpDialog {
    constructor(id) {
        super(id || 'dateResolverStartDialog');
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = "Couldn't get the travel date! On what date would you like to travel ?";
        const promptMessage = MessageFactory.text(promptMessageText, promptMessageText, InputHints.ExpectingInput);

        const repromptMessageText = "I'm sorry, for best results, please enter your correct travel date including proper month, day and year.";
...
module.exports.DateResolverStartDialog = DateResolverStartDialog;
